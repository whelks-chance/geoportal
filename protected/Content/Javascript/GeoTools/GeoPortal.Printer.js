...
Ext.ux.Printer.BaseRenderer = Ext.extend(Object, {
    ...
    */
    generateHTML: function (component) {
      ...
      '<html>',
        ...
        '</head>',
        '<body>',
        '<img src="../../../images/Logos/wiserd-logo.png" alt="wiserdlogo" />',
          this.generateBody(component),
          '<img src="../../../images/Logos/institutions.png" alt="wiserdlogo" />',
        '</body>',
      '</html>'
    ...
    */
    stylesheetPath: '../../Content/CSS/Printer.css'
...
Ext.ux.Printer.BaseRenderer.prototype.stylesheetPath = '../../Content/CSS/Printer.css';
