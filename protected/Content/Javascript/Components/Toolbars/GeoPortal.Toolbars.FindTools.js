...
function doSpatialSearch(geography, loadMask) {
	...
	grdqual.store.load({ params: { geography: geography, start: 0, limit: 15, type: 'Qual' }, callback: function () {
		grid.store.load({ params: { start: 0, limit: 15, type: 'Quant' }, callback: function () { searchResults.show(); loadMask.hide(); } });
