<%@ WebHandler Language="C#" Class="gzip" %>
...
public class gzip : IHttpHandler {
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        string[] scripts = Request["src"].Split(';');
        ...
        foreach (var src in scripts)
        {
            ...
            {
                 StreamReader sr = new StreamReader(context.Server.MapPath("~/Content/JavaScript/" + src));
        ...
        Context.Cache.Add(CacheKey, Output, null, DateTime.UtcNow.AddDays(10), TimeSpan.Zero, System.Web.Caching.CacheItemPriority.High, null);
